...
export default function InventoryPage() {
  ...
  return (
    <div className="px-4 pt-6">
      ...
      {/* Snap & Sell — price a flat-lay photo of sealed products */}
      <Link
        href="/snap-sell"
        className="flex items-center gap-3 bg-primary-800 border border-primary-600 rounded-xl px-4 py-3 mb-4"
      >
        <svg className="w-5 h-5 text-primary-200 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z" />
        </svg>
        <div className="flex-1 min-w-0">
          <p className="text-primary-50 text-sm font-semibold">Snap &amp; Sell</p>
          <p className="text-primary-200 text-[11px]">
            Photo of sealed products → price badges → share to FB/WhatsApp
          </p>
        </div>
        <svg className="w-4 h-4 text-primary-200 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
